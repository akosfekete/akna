<?php
    ...
    if(isset($_POST["felhasznalonev"]) && isset($_POST["jelszo"]) && isset($_POST["email"])) {
        ...
        if(is_null($error)) {
            header('refresh: 3 ; url = http://localhost/akna/login.php');
...
<?php include("header.php"); ?>
                   ...
                   <?php echo is_null($message) ? "" : "<label class=\"message\">Üzenet: $message</label><br><br>"; ?>
                    ...
                    <label for="jelszo" class="kotelezo">Jelszó:</label> <br> <input type="password" name="jelszo" placeholder="Jelszó"> <br><br>
